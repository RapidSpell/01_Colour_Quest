...
class PlayGame:
    ...
    def __init__(self, num_games, temp_games=0):
        """
        ...
        while temp_games > 0:
            ...
            self.end_game_button = Button(self.play_frame, text="End",fg="#000000",
                                          bg="#ff0000", width=5, height=1, font=("Arial", 16, "bold"),
                                          command=self.close_play)
            self.end_game_button.grid(row=1)

    def close_play():
        # send user back to round select page
        Converter()
